...
#ifndef LAWA_METHODS_ADAPTIVE_OPERATORS_ADAPTIVESPACETIMEWEIGHTEDCONVECTIONOPERATOR1D_H
#define LAWA_METHODS_ADAPTIVE_OPERATORS_ADAPTIVESPACETIMEWEIGHTEDCONVECTIONOPERATOR1D_H 1
...
struct AdaptiveSpaceTimeWeightedConvectionOperator1D : public AdaptiveOperator2D<T> {
    ...
    typedef WeightedConvectionOperator1D<T, Basis_x, Gauss>    ConvectionOperator_x;
    ...
    AdaptiveSpaceTimeWeightedConvectionOperator1D(const Basis2D& _basis, LeftPrec2D& _p_left, RightPrec2D& _p_right,
                                    Function<T> weightFct, T _convection = 1);
...
#include <lawa/methods/adaptive/operators/spacetimeoperators/adaptivespacetimeweightedconvectionoperator1d.tcc>

#endif // LAWA_METHODS_ADAPTIVE_OPERATORS_ADAPTIVESPACETIMEWEIGHTEDCONVECTIONOPERATOR1D_H
