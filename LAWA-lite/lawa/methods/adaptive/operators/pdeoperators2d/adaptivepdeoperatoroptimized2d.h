...
struct AdaptivePDEOperatorOptimized2D
{

};

template <typename T, DomainType Domain1, DomainType Domain2>
struct AdaptivePDEOperatorOptimized2D<T,Primal,Domain1,SparseMulti,Primal,Domain2,SparseMulti>
{
    ...
    apply(const Coefficients<Lexicographical,T,Index2D> &v, T eps,
          Coefficients<Lexicographical,T,Index2D> &ret, cxxblas::Transpose trans=cxxblas::NoTrans);
...
#include <lawa/methods/adaptive/operators/pdeoperators2d/adaptivepdeoperatoroptimized2d.tcc>

#endif // LAWA_METHODS_ADAPTIVE_DATASTRUCTURES_OPERATORS_ADAPTIVEPDEOPERATOROPTIMIZED2D_H
