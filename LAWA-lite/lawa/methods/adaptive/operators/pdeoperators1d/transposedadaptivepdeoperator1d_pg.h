...
#ifndef LAWA_METHODS_ADAPTIVE_OPERATORS_TRANSPOSEDADAPTIVEPDEOPERATOR1D_PG_H
#define LAWA_METHODS_ADAPTIVE_OPERATORS_TRANSPOSEDADAPTIVEPDEOPERATOR1D_PG_H 1
...
/* Transposed Adaptive PDE OPERATOR: Petrov Galerkin version
 *
 *    a(v,u)^T =  [diffusion * Integral(v_x * u_x) +  convection * Integral(v * u_x)
 *              + reaction * Integral(v * u)]^T
 *
 */
template <typename T, typename TrialBasis, typename TestBasis>
struct TransposedAdaptivePDEOperator1D_PG
{
    typedef flens::SparseGeMatrix<flens::CRS<T,flens::CRS_General> >        SparseMatrixT;
    typedef NoCompression<T,Index1D,TrialBasis>                        		NoCompression1D;
    typedef NoPreconditioner<T,Index1D>                                     NoPreconditioner1D;
    typedef TransposedPDEOperator1D_PG<T,TrialBasis,TestBasis>              PDEOp1D;
...
#include <lawa/methods/adaptive/operators/pdeoperators1d/transposedadaptivepdeoperator1d_pg.tcc>

#endif // LAWA_METHODS_ADAPTIVE_OPERATORS_TRANSPOSEDADAPTIVEPDEOPERATOR1D_PG_H
