...
#ifndef LAWA_METHODS_ADAPTIVE_DATASTRUCTURES_OPERATORS_TRANSPOSEDADAPTIVEIDENTITYOPERATOR1D_PG_H
#define LAWA_METHODS_ADAPTIVE_DATASTRUCTURES_OPERATORS_TRANSPOSEDADAPTIVEIDENTITYOPERATOR1D_PG_H 1
...
/* Transposed Adaptive Identity OPERATOR: Petrov Galerkin version
 *
 *    a^T(v,u) = [Integral(v * u)]^T : a^T_ij = Integral( testbf_j * trialbf_i)
 *
...
struct TransposedAdaptiveIdentityOperator1D_PG
{
    typedef flens::SparseGeMatrix<flens::CRS<T,flens::CRS_General> >        SparseMatrixT;
    typedef NoCompression<T,Index1D,TrialBasis>                        		NoCompression1D;
    typedef NoPreconditioner<T,Index1D>                                     NoPreconditioner1D;
    typedef TransposedIdentityOperator1D_PG<T,TrialBasis,TestBasis>         IdentityOp1D;
...
#include <lawa/methods/adaptive/operators/pdeoperators1d/transposedadaptiveidentityoperator1d_pg.tcc>

#endif // LAWA_METHODS_ADAPTIVE_DATASTRUCTURES_OPERATORS_TRANSPOSEDADAPTIVEIDENTITYOPERATOR1D_PG_H
